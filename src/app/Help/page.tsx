        ...
        <div className="w-full lg:w-1/3 bg-gray-100 p-6 rounded-lg">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              <FiPhone size={30} className="text-gray-500" />
              <div>
                <p className="font-medium">093 864 786 0876</p>
                <p className="text-sm text-gray-600">
                  Products & Orders: 24 hours a day, 7 days a week
                </p>
                <p className="text-sm text-gray-600">
                  Company Info & Enquiries: <br />10:00 AM - 10:00 PM , Monday - Friday
                </p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <LuMessageCircleMore size={30} className="text-gray-500" />
              <p className="text-sm text-gray-600">
                24 hours a day, 7 days a week
              </p>
            </div>
            <div className="flex items-center gap-4">
              <FiMail size={30} className="text-gray-500" />
              <p className="text-sm text-gray-600">
                Well reply within five business days
              </p>
            </div>
            <div className="flex items-center gap-4">
              <ImLocation2 size={30} className="text-gray-500" />
              <p className="text-sm text-gray-600">
