...
export default function Hero(){
    return(
        <section className="flex justify-center flex-col items-center bg-gray-100 m-4 ">
         ...
         <span>Download the app to access everything Nike.</span>{" "}
           <Link href={"/"}> Get Your Great</Link>
            ...
            ">
                ...
                <Button className="bg-gray-300 hover:bg-slate-500 hover:shadow-lg font-semibold">Notify Me</Button>
                <Button className="bg-gray-300 hover:bg-slate-500 hover:shadow-lg font-semibold">Shop Air Max</Button></div>
            </div>
        </section>
    )
