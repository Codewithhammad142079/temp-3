...
export default function Nav() {
  return (
    ...
    <div className="bg-gray-100 flex justify-between items-center px-6 py-2 md:text-[11px] sm:text-[9px] text-[8px] font-medium text-gray-500">
      ...
      <div>
  <p className="text-black text-sm">Welcome To Our Store!</p>
</div>
      <div className="flex md:gap-4 sm:gap-3 gap-2">
        <Link href="/locate" className="hover:text-gray-800">Find Link Store</Link><p>|</p>
        <Link href="/Help" className="hover:text-gray-800">Help</Link><p>|</p>
        <Link href="/JoinUs" className="hover:text-gray-800">Join Us</Link><p>|</p>
        <Link href="/Login" className="hover:text-gray-800">Sign In</Link><p>|</p>
      </div>
    </div>
